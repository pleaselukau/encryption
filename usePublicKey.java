...
public class usePublicKey{
	...
	byte[] myArray = Files.readAllBytes(message.toPath()); //msg converted into byte array
	...
	BigInteger b = ModularExponentiatin.modularExponentiation(m,e,n);
	//then write the output into a file
	Files.write(Paths.get("encryptedWithPublic.txt"), b.toByteArray());
